...
<body>
    <div class="mid">
     ...
     <?php
      ...
      print(dechex("$ip1"));echo "<br>";
      print(decbin("$ip2")); echo " ----- ";
      print(dechex("$ip2"));echo "<br>";
      print(decbin("$ip3")); echo " ----- ";
      print(dechex("$ip3")); echo "<br>";
      print(decbin("$ip4")); echo " ----- ";
      print(dechex("$ip4"));}
      if(isset($_POST['druhy'])){$binnum = $_POST['text2'];
      list($bin1, $bin2, $bin3, $bin4) = explode(",", "$binnum");
      print(bindec("$bin1"));echo " ----- ";
      printf(dechex(bindec($bin1)));echo "<br>";
      print(bindec("$bin2"));echo " ----- ";
      printf(dechex(bindec($bin2)));echo "<br>";
      print(bindec("$bin3"));echo " ----- ";
      printf(dechex(bindec($bin3)));echo "<br>";
      print(bindec("$bin4"));echo " ----- ";
      ...
      printf(decbin(hexdec($hex1)));echo "<br>";
      print(hexdec("$hex2"));echo " ----- ";
      printf(decbin(hexdec($hex2)));echo "<br>";
      print(hexdec("$hex3"));echo " ----- ";
      printf(decbin(hexdec($hex3)));echo "<br>";
      print(hexdec("$hex4"));echo " ----- ";
      printf(decbin(hexdec($hex4)));echo "<br>";}?> 
</body>
</html>